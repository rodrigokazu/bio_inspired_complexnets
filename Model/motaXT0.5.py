...
def get_new_random_edge():
    ...
    if v1['id'] % neurons_per_module == -1 % neurons_per_module:
        forward_edge = False
        
    if v1['id'] % neurons_per_module == 0:
        forward_edge = True
    ...
    if cross_modules:
        ...
        if forward_edge:
            edge_reach = random.randint(1, neurons_per_module - v1['id'] % neurons_per_module - 1)
        else:
            edge_reach = random.randint(1, v1['id'] % neurons_per_module)
